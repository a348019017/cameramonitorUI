...
<template>
  <div :class="themsDefault">
    <div class="menuBoxContainer">
      ...
      <transition name="el-zoom-in-top">
        <div class="menuBoxContent" v-show="isShowToolBar">
          <p class="menuBoxList">
            <el-tooltip v-for="(item, i) in toolBarData" v-show="!item.hide" class="item" effect="dark" :key="i"
              :content="item.title" placement="left">
    ...
    <component v-for="(item, i) in toolBarData" :key="item.name" ref="customcom" :is="getcomps(item)" :titem="item">
    </component>
  </div>
</template>
